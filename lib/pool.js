...
Pool.prototype.__defineGetter__('length', function() {
  if (typeof this._sockets !== 'object') console.log(this._sockets)
 ...
 */
 Pool.prototype.add = function(socket) {
  ...
  pSocket.pid = util.generateId(this._sockets[server]);
  this._sockets[server][pSocket.pid] = pSocket;
...
Pool.prototype.drain = function() {
   ...
   var groups = Object.keys(this._sockets);
   for (var i = 0, l = groups.length; i < l; i++) {
      var group = this._sockets[groups[i]]
